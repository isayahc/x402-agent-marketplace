...
export function GET(request: NextRequest) {
  ...
  return new Response(
    [
      ...
      `- Marketplace Agent Card: ${baseUrl}/.well-known/agent-card.json`,
      `- Paid A2A message/send: ${baseUrl}/api/a2a/message:send`,
      `- A2A interface runs: ${baseUrl}/api/a2a/runs`,
      "",
      "Buyer agent flow:",
      ...
      "",
      "Paid A2A flow:",
      "1. Create a quote for a seller capability.",
      "2. Pay POST /api/pay?quote_id=<quote_id> with x402.",
      "3. Send POST /api/a2a/message:send with quote_id, execution_token, and an A2A user message.",
      "4. Inspect task state with GET /api/a2a/tasks/<task_id> or run logs with GET /api/a2a/runs/<run_id>.",
      "",
      "Payment:",
      "- Protocol: x402 v2",
      "- Scheme: exact",
